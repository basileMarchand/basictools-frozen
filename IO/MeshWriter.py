...
def WriteMesh(filename,mesh,SolAtVertices=None,solutionOnOwnFile= False, binary=True, nodalRefField= None,elemRefField=None):
    OW = MeshWriter()
    OW.SetBinary(binary);
    OW.Open(filename)
    OW.Write(mesh,SolAtVertices = SolAtVertices,solutionOnOwnFile=solutionOnOwnFile, nodalRefField=nodalRefField,elemRefField=elemRefField)
    OW.Close()
