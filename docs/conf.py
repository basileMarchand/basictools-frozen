# -*- coding: utf-8 -*-
#
# BasicTools documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('..'+os.sep+'src'))
...
project = BasicTools__name__
copyright = BasicTools__copyright__
...
version = BasicTools__version__
# The full version, including alpha/beta/rc tags.
release = BasicTools__version__
...
modindex_common_prefix = ['BasicTools.']
...
htmlhelp_basename = 'BasicToolsdoc'
