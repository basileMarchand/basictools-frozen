...
To compile and install BasicTools (version 1.9.11 in this case) with pip:
    ...
    pip install BasicTools@https://gitlab.com/drti/basic-tools/-/archive/1.9.11/basic-tools-1.9.11.tar.bz2
