...
To compile and install BasicTools (version 1.9.10 in this case) with pip:
    ...
    pip install BasicTools@https://gitlab.com/drti/basic-tools/-/archive/1.9.10/basic-tools-1.9.10.tar.bz2
